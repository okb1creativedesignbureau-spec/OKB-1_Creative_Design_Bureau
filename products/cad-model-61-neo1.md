...
The Model 61 was envisioned as a **twin-engine turbofan airliner** using the **JT8D turbofan series**, derived from the **Convair 990’s powerplant lineage**. In contrast to the four-engine Convair 880 and 990, the Model 61 sought to achieve:
...
- **Span:** 36.58 m  
- **Root-Tip Airfoil:** NACA 64-0012 - NACA 64-0008  
...
## Powerplant — JT8D series

The baseline engine assumption is the **JT8D-17AR**, producing approximately:

- **77 kN thrust per engine**

A later conceptual upgrade suggests a **JT8D-219**, estimated at:

- **93 kN thrust per engine**
...
## JT8D-17A/R/AR Era — Transitional Upgrade

The JT8D-17AR provides improved reliability and moderate thrust increase over CJ805, enabling higher payload flexibility.

**Typical thrust class:** ~73–75 kN
...
- Increased allowable structural weight
- Improved runway performance

---

## JT8D-200 Era — MD-80 Class Capability

The JT8D-200 represents a major step forward in thrust and payload performance, comparable to late MD-80 aircraft.

**Thrust class:** ~84-93 kN
...
- Higher passenger capacity (~120–155 seats)

...
[Main Article: VC-10 Prototype Series 1100](https://okb1creativedesignbureau-spec.github.io/OKB-1_Creative_Design_Bureau/products/cad-vc10-1100.html)
...
- Fuselage: Original prototype length, preserving the authentic proportions that first took to the skies.
- Wingtips: Squarish and distinctive, reflecting the early aerodynamic experiments before refinement in later models.
- Engine nacelles: Bulkier than production variants, a faithful nod to the dragier configuration of the prototype.
- Wing-fuselage connection: Less streamlined than future iterations, showcasing the engineering challenges solved in later designs.
- Engine platform: Traditional airfoil shape, without the drag-reducing “bulge” covers seen on production aircraft.
- Wing root chord: Thinner than the Series 1102 and subsequent models, capturing the prototype’s original aerodynamic layout. 
...
- Fuselage and wings: Solid lofted NURBS geometry capturing the original prototype shape.
- Engine nacelles and pylons: Accurate aerodynamic forms reflecting the raw design.
- Cross-sections and structure: Exportable in DXF/DWG for engineering analysis or 3D printing. 
...
- Engine nacelles: Streamlined for lower drag, featuring early “bulge” covers developed after prototype testing.
- Wingtips: Sleek, swept, and aerodynamically refined compared to the squarish prototype tips.
...
- Engine nacelles: Fully refined trailing-edge design, more pointed and streamlined than 1102, reducing drag.
- Wing design: Optimized wing-fuselage integration with slightly wider root chords and improved curvature.
...
- Fuselage and wings: Mathematically precise solids reflecting military reinforcements.
...
[Main Article: Super VC-10 Series 1151](https://okb1creativedesignbureau-spec.github.io/OKB-1_Creative_Design_Bureau/products/cad-vc10-1151.html)
...
- Engine nacelles: Trailing-edge, pointed, and aerodynamically refined.
- Tail assembly: Iconic T-tail recreated with precision.
- Cross-sections: Exportable for study or fabrication. Why It Matters 

The Super VC-10 is a symbol of British aerospace engineering, mid-century elegance, and timeless design. Digitally preserved, it allows study, appreciation, and recreation of the VC-10 at its most iconic.

# VC-10 Series 1400: The “What-If” Vision of a Shorthaul Horse

[Main Article: Proposed Shortened VC-10 Series 1400](https://okb1creativedesignbureau-spec.github.io/OKB-1_Creative_Design_Bureau/products/cad-vc10-1400.html)
...
# Back to Main VC-10 Homepage 
  
- [VC-10 Main](https://okb1creativedesignbureau-spec.github.io/OKB-1_Creative_Design_Bureau/products/vc10.html)
- [Home Page Index](https://okb1creativedesignbureau-spec.github.io/OKB-1_Creative_Design_Bureau/)
